...
class CriandoTabelaFilaDoadoresTriagem extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('fila_doadores_triagem', function (Blueprint $table) {
            $table->increments('id_fila_triagem'); //Chave primária
    ...
    {
        Schema::dropIfExists('fila_doadores_triagem');
    }
}
