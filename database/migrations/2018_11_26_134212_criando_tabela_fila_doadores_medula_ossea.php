...
class CriandoTabelaFilaDoadoresMedulaOssea extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('fila_doadores_medula_ossea', function (Blueprint $table) {
            $table->increments('id_fila_doador_medula_ossea'); //Chave primária
    ...
    {
        Schema::dropIfExists('fila_doadores_medula_ossea');
    }
}
